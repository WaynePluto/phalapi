...
class Menu
{
    ...
    public function addNewMenu($title, $parent_id, $id, $href, $sort_num, $target, $icon)
    {
    ...
    public function updateMenu($id, $icon, $title, $href, $sort_num, $assign_admin_roles = array(), $assgin_admin_usernames = '')
    {
        $model = new MenuModel();
        $updateData = array(
            'title' => $title,
